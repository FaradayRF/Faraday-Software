...
class transmit_object(object):
    ...
    def receive(self):
        # I need to make the receiver loop on a threaded loop
        #faraday_rx_msg_object.rxmsgloop(local_device_callsign, local_device_node_id,
        #self.rx_uart_service_port_application_number, self.GETWAIT_TIMEOUT)
        pass
