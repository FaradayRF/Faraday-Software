...
while(1):
    ...
    data = faraday_1.GETWait(local_device_callsign, local_device_node_id, PROXY_MESSAGE_EXPERIMENTAL_PORT, PROXY_GET_TIMEOUT, False)
    ...
    if(data != False):
        ...
        print "Received Message Decoded:", faraday_1.DecodeJsonItemRaw(data[0]['data'])
