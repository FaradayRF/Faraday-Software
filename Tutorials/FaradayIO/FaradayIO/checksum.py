...
def compute_checksum_16(packet, length):
    """
    Computes a basic 16 bit checksum of a supplied string of bytes (packet) and length. This is used for
    error detection purposes.

    :param packet: The packet that the checksum will be computed as a string of bytes
    :param length: The length of the supplied packet to compute a checksum of.
