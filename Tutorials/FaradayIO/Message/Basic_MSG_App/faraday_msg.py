...
class message_app_Rx(object):
    ...
    def GetNextFrame(self):
        print repr(self.faraday_Rx.GETWait(self.local_device_callsign, self.local_device_node_id, self.faraday_Rx.CMD_UART_PORT, 1, False))
    ...
    def RxMsgLoop(self):
            ...
            if(data != False):
                for item in data:
                    ...
                    datagram = datagram[0:42] #All frames are 42 bytes long and need to be extracted from the much larger UART frame from Faraday
